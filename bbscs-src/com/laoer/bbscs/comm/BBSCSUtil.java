...
public class BBSCSUtil {
	...
	public static String getActionMappingURLWithoutPrefix(String action) {//作用是转换url,显示的是转换后的url

		StringBuffer value = new StringBuffer();

		// Use our servlet mapping, if one is specified
		String servletMapping = Constant.SERVLET_MAPPING;//SERVLET_MAPPING = "*.bbscs";
		if (servletMapping != null) {
