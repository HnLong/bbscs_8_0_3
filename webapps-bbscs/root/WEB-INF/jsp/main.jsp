...
<%@taglib uri="/WEB-INF/bbscs.tld" prefix="bbscs"%><%@taglib uri="/WEB-INF/test.tld" prefix="my"%>
<html>
<head>
<title><bbscs:webinfo type="forumname"/><bbscs:webinfo type="poweredby"/>
        ...
        <tr>
          <td onclick="switchSysBar()">
            <font class="switchbarfont">
              ...
              <br>
              <br>
              <span style="color:#8B864E">屏幕切换</span>
            </font>
          </td>
        </tr>
      </table>
